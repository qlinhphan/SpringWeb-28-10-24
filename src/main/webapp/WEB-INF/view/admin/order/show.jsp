    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        ...
        <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0">
            <div class="input-group">
                <button class="btn btn-primary" id="btnNavbarSearch" type="button"><i class="fas fa-search"></i><a
                        href="/homePage/client" style="color: wheat; margin-left: 17px; text-decoration: none;">Page
                        User</a></button>
            </div>
        </form>
        <!-- Navbar-->
